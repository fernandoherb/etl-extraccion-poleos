...
## Ejecutar script
echo "Ejecutar script  que descarga e inserta información de poleos de cpu a dwh cada 4 minutos"
echo $SOURCE_CODE_DIR"main_carga_cpu.py"
python3 "$SOURCE_CODE_DIR"main_carga_cpu.py > $SOURCE_CODE_DIR"logs/log_load_tr_python_carga_cpu.log" 2>&1
