...
## Ejecutar script
echo "Ejecutar script  que descarga e inserta información de poleos del trafico de interfaces a dwh cada 4 minutos"
echo $SOURCE_CODE_DIR"main_tiempo_respuesta.py"
python3 "$SOURCE_CODE_DIR"main_trafico_interfaces.py > $SOURCE_CODE_DIR"logs/log_load_tr_python_interfaces.log" 2>&1
