...
OUTPUT_ETL_LOAD_ERROR_INTERFACE_7D_QUERY_FILENAME = 'query_insert_detalle_error_interface_7d'
OUTPUT_ETL_LOAD_CARGA_CPU_7D_QUERY_FILENAME = 'query_insert_detalle_carga_cpu_7d'
OUTPUT_ETL_LOAD_TIEMPO_RESPUESTA_7D_QUERY_FILENAME = 'query_insert_detalle_tiempo_respuesta_7d'
OUTPUT_ETL_LOAD_TRAFICO_INTERFACE_7D_QUERY_FILENAME = 'query_insert_detalle_trafico_interface_7d'
